  ...
  function Book({ className, index }) {
    return (
      <div className={`${className} pb-2`}>
        ...
        <div
          ref={refPrev}
          className={`book-preview my-8 lg:mt-48 lg:top-0 lg:right-8 p-4 lg:p-8 preview${index} hide static lg:absolute w-full lg:w-1/2`}
        >
          <img
            src={props.bookCardsChernyshev[index].image}
            className="book-image w-40 lg:w-72 mx-auto"
          />
          <div className="book-btn w-full mt-4 lg:mt-8 p-1 lg:p-2 text-2xl lg:text-3xl mx-auto">
            Читать фрагмент
          </div>
